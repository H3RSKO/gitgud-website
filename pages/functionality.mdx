...
- ### **Stage Changes**
  ...
  <br />
  <img width="100%" src="/stage_screenshot.png" />
- ### **Commit Changes**
  ...
  <br />
  <img width="100%" src="/commit_screenshot.png" />
- ### **Push Staged Changes**
  -- This will push staged changes to the branch you are on
  <br />
  <img width="100%" src="/push_screenshot.png" />
- ### **Checkout Branch**
  ...
  <img width="100%" src="/checkout_screenshot.png" />
- ### **Delete Branch**
  ...
  <img width="100%" src="/delete_screenshot.png" />

  -- Press 'ESC' to exit out of delete branch

- ## Other functionality

  <img width="100%" src="/other.png" />
  <br />
  <img width="100%" src="/inside_other.png" />
